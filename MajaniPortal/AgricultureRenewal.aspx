<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AgricultureRenewal.aspx.cs" Inherits="MajaniPortal.AgricultureRenewal" %>
                ...
                <tbody>
                    ...
                    <tr>
                      <td><%=counter %></td>
                        ...
                        <td>
                            <label class="btn btn-danger" onclick="removeDependant('<%=item.Code %>');"><i class="fa fa-trash"></i>Deactivate</label></td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Are you sure you want to deactivate the livestock <strong id="depedantToDelete"></strong>?</p>
                        <asp:TextBox runat="server" ID="removedependantCode" type="hidden" />
                         <div class="row">                       
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <strong>Reasons For  De-Activation:</strong>
                                <asp:TextBox runat="server" CssClass="form-control" ID="reasons" TextMode="MultiLine" Rows="3"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:Button runat="server" CssClass="btn btn-danger" Text="Deactivate Dependant" id="delit" OnClick="delit_Click" />
                    </div>
                </div>
            </div>
        </div>
