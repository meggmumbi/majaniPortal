<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="MotorIndividualClientApplication.aspx.cs" Inherits="MajaniPortal.MotorIndividualClientApplication" %>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:CheckBox CssClass="form-control" runat="server" ID="hasgrowerNo" OnCheckedChanged="HasGrowerNumber_Selected" AutoPostBack="true"></asp:CheckBox>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <span class="text-danger" style="font-size: 25px">*</span>
                        <asp:TextBox CssClass="form-control text-transform:uppercase" runat="server" ID="txtfirstname"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control upper-case" runat="server" ID="txtMiddleName"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <span class="text-danger" style="font-size: 25px">*</span>
                        <asp:TextBox CssClass="form-control upper-case" runat="server" ID="txtlastname"></asp:TextBox>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:DropDownList CssClass="form-control select2" runat="server" ID="ttxtoccupations"></asp:DropDownList>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control upper-case" runat="server" ID="txtHudumaNo"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                       ...
                       <asp:DropDownList CssClass="form-control" runat="server" ID="lblcity" readonly="true"></asp:DropDownList>
                    </div>
                </div>
            ...
            <div class="row">   
                 ...
                 <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control" runat="server" ID="paymentreferenceccode"  MaxLength="10"></asp:TextBox>
                         <asp:RegularExpressionValidator runat="server" Display="dynamic" ValidationExpression="^([\S\s]{10,10})$" ControlToValidate="paymentreferenceccode" ErrorMessage="Please Enter the Correct Payments Reference Code,It must be 10 Characters" BackColor="Red" />
