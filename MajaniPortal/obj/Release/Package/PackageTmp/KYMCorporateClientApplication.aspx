<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="KYMCorporateClientApplication.aspx.cs" Inherits="MajaniPortal.KYMCorporateClientApplication" %>
    ...
    <div class="panel panel-primary">
        ...
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:DropDownList CssClass="form-control select2" runat="server" ID="applicanttype" Placeholder="Select Customer Category" OnSelectedIndexChanged="GetFactoryDetails_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                    </div>
                </div>
                  <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <asp:RegularExpressionValidator runat="server" Display="dynamic" ValidationExpression="^([\S\s]{9,9})$" ControlToValidate="growerNumber" ErrorMessage="Please Enter the Correct Grower No Value,It must be a Whole number with 9 Characters" BackColor="Red" />
            ...
            <div class="row">
                 <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>County </label><span class="text-danger" style="font-size:25px">*</span>
            ...
            <div class="row">                
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control" runat="server" ID="bankaccountNumber"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Bank Name</label><span class="text-danger" style="font-size:25px">*</span>
                        <asp:TextBox CssClass="form-control" runat="server" ID="bankaccountname"></asp:TextBox>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control" runat="server" ID="telnumber1"></asp:TextBox>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Tel/Mobile No2. </label><span class="text-danger" style="font-size:25px">*</span>
                      ...
                      <asp:TextBox CssClass="form-control" runat="server" ID="telnumber2"></asp:TextBox>
                    </div>
                </div>
            </div>
            ...
            <div class="row">                
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control" runat="server" ID="txtinsurerName" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
        ...
        <div class="box-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <td style="background-color:burlywood"><a href="CorporateDependantConditions.aspx?requisitionNo=<%=requisitionNo%>&&GrowerNumber=<%=GrowerNumber%>&&DependantNo=<%=application.Dependant_Code %>"</a><% =application.Dependant_Code%> </td>                      
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Condition Name</label><span class="text-danger" style="font-size:25px">*</span>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    <strong>Allocation:</strong><asp:TextBox runat="server" CssClass="form-control " placeholder="Allocation" ID="txtallocation" TextMode="Number" />
                                </div>
                            </div>
                        </div>
                    </div>
