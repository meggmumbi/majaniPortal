<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="KYMCorporateExistingBusiness.aspx.cs" Inherits="MajaniPortal.KYMCorporateExistingBusiness" %>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:DropDownList CssClass="form-control select2" runat="server" ID="applicanttype" Placeholder="Select Customer Category" OnSelectedIndexChanged="ValidateKRAPin_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                    </div>
                </div>
                  <div class="col-md-6 col-lg-6">
                    <div class="form-group">
