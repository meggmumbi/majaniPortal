<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="MajaniPortal.Login" %>
<!DOCTYPE html>
<html lang="en">
<head>
	<title>Login</title>
				...
				<div class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">Username</span>
                         <asp:TextBox CssClass="input100" runat="server" ID="username" Placeholder="Please Enter Valid username" required Style="height: 42px;" />
					...
					<div class="container-login100-form-btn">
                        <asp:Button runat="server" CssClass="login100-form-btn" ID="login" Text="Login" OnClick="login_Click"/>
					</div>
				</div>
			</div>
		</div>
