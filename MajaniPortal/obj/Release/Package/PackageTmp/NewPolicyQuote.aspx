<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="NewPolicyQuote.aspx.cs" Inherits="MajaniPortal.NewPolicyQuote" %>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:DropDownList CssClass="form-control" runat="server" ID="lblcustomers" Placeholder="Select Customers"></asp:DropDownList>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:DropDownList CssClass="form-control" runat="server" ID="txtpolicytype" Placeholder="Select Customers" OnSelectedIndexChanged="Poducts_Onclick" AutoPostBack="true"></asp:DropDownList>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:DropDownList CssClass="form-control" runat="server" ID="typeofapplication" Placeholder="Select Customers"></asp:DropDownList>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Mode of Payment</label>
                        <asp:DropDownList CssClass="form-control" runat="server" ID="lblmodeofpayments" Placeholder="Select Mode of Payments"></asp:DropDownList>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:DropDownList CssClass="form-control" runat="server" ID="lblproductbillingCycle" Placeholder="Select Product Billing Cycle"></asp:DropDownList>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:DropDownList CssClass="form-control" runat="server" ID="lblmembertype" Placeholder="Select Member Type"></asp:DropDownList>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:DropDownList CssClass="form-control" runat="server" ID="lblagentDetails" Placeholder="Select Agent Code"></asp:DropDownList>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Agent Code</label>
                        <asp:DropDownList CssClass="form-control" runat="server" ID="lblAgentCode" Placeholder="Select Agent Code"></asp:DropDownList>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>DHB</label>
                        <asp:DropDownList CssClass="form-control" runat="server" ID="dhbs" Placeholder="Select DHB"></asp:DropDownList>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Referral ID No.</label>
                         <asp:TextBox CssClass="form-control" runat="server" ID="txtreferalidnumber"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Referral Name</label>
                         <asp:TextBox CssClass="form-control" runat="server" ID="txtreferralName"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Referral Mobile No.</label>
                         <asp:TextBox CssClass="form-control" runat="server" ID="txtreferralMobileNumber"></asp:TextBox>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="box-body">
         ...
         <div class="panel-footer">
            ...
            <asp:Button runat="server" CssClass="btn btn-success pull-right" Text="Next" OnClick="nextstep_Click" ID="next" />
            <div class="clearfix"></div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                <strong>Id number:</strong><asp:TextBox runat="server" CssClass="form-control" placeholder="ID Number" ID="txtidnumber" />
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
