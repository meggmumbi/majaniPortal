<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="MotorCorporatePolicyAmmendments.aspx.cs" Inherits="MajaniPortal.MotorCorporatePolicyAmmendments" %>
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Customer Category</label><span class="text-danger" style="font-size: 25px">*</span>
                        <asp:TextBox CssClass="form-control" runat="server" ID="subcustomerCategory"  ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control select2" runat="server" ID="applicanttype" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control select2" runat="server" ID="countryresidence" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control select2" runat="server" ID="lblcounties" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control" runat="server" ID="tnatureofbusinesses" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control" runat="server" ID="txtresidential" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="panel-footer">
                <asp:Button runat="server" CssClass="btn btn-success pull-right" Text="Next" OnClick="Next_Click" ID="Button3" />
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control" runat="server" ID="membertype" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
