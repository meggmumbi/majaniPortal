<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="KYMIndividualClientApplication.aspx.cs" Inherits="MajaniPortal.KYMIndividualClientApplication" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainBody" runat="server">
                ...
                <tbody>
                    ...
                    <tr>                       
                        ...
                        <td><%= application.Description %></td>
                          <td>
                          <label class="btn btn-danger" onclick="removeCondition('<%=application.code %>');"><i class="fa fa-trash"></i>Remove</label>
    ...
    <div class="panel panel-primary">
        ...
        <div id="deleteBeneficiaryModal" class="modal fade" role="dialog">
         ...
         <div id="deleteConditionModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Confirm Removing Condition</h4>
                    </div>
                    <div class="modal-body">
                        <p>Are you sure you want to remove Condition <strong id="ConditionToDelete"></strong>?</p>
                        <asp:TextBox runat="server" ID="ConditioncodetoRemove" type="hidden" />
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                        <asp:Button runat="server" CssClass="btn btn-danger" Text="Remove Condition" OnClick="DeleteCondition_Click" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <tbody>
                    <%
                        try
                        {
                            ...
                            GrowerNumber = GrowerNumber.Replace(':', '_');
                            String filesFolder = ConfigurationManager.AppSettings["FilesLocation"] + "Individual Client Underwriting/";
                            String ApplicantionNo = Request.QueryString["requisitionNo"].Trim();
                            string str1 = Convert.ToString(ApplicantionNo) +'_'+ Convert.ToString(GrowerNumber);
