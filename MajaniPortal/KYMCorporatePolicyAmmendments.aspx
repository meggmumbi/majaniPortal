<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="KYMCorporatePolicyAmmendments.aspx.cs" Inherits="MajaniPortal.KYMCorporatePolicyAmmendments" %>
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <p><b>Have you ever suffered from a serious health condition?<span class="text-danger" style="font-size: 25px">*</span></b></p>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<asp:DropDownList runat="server" ID="dependantconditions"></asp:DropDownList>
