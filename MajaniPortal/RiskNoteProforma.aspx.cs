...
{
    public partial class RiskNoteProforma : System.Web.UI.Page
    {
        ...
        protected void next_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AgricultureIndividualClientApplication.aspx?requisitionNo=" + docNo + "&step=5");
        ...
        protected void previoes_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AgricultureIndividualClientApplication.aspx?requisitionNo=" + docNo + "&step=4" + "&product=" + tproduct);
