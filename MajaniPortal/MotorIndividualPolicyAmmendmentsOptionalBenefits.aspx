<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="MotorIndividualPolicyAmmendmentsOptionalBenefits.aspx.cs" Inherits="MajaniPortal.MotorIndividualPolicyAmmendmentsOptionalBenefits" %>
             ...
             <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <%
                        ...
                        {
                            TotalOptionalAmounts =Convert.ToString(application.Amount);
                    %>
                    <tr>
