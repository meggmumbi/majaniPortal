<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="DependantConditons.aspx.cs" Inherits="MajaniPortal.DependantConditons" %>
     ...
     <div class="panel panel-primary">
        ...
        <div class="box-body">
            <div class="row">
             ...
             <asp:Button runat="server" CssClass="btn btn-success pull-right" Text="Next" OnClick="previousstep_Click" />
        </div>
