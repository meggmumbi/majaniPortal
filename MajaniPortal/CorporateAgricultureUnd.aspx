<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CorporateAgricultureUnd.aspx.cs" Inherits="MajaniPortal.CorporateAgricultureUnd" %>
    ...
    <div class="panel panel-primary">
        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Certificate of Incorporation</label><span class="text-danger" style="font-size: 25px">*</span>
                        <asp:TextBox CssClass="form-control" runat="server" ID="txtIdNumber"></asp:TextBox>
                        <asp:RegularExpressionValidator runat="server" Display="dynamic" ValidationExpression="^([\S\s]{11})$" ControlToValidate="txtIdNumber" ErrorMessage="Please Enter the Correct ID No/Passport Value,It must be a Whole number 11 digits " BackColor="Red" />
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:DropDownList CssClass="form-control select2" runat="server" ID="wealthSource" Placeholder="Select Source of Wealth">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Source of Income</label><span class="text-danger" style="font-size: 25px">*</span>
                        <asp:DropDownList CssClass="form-control select2" runat="server" ID="sourceIncome">
