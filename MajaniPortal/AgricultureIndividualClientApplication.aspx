                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Has Binder?</label><span class="text-danger" style="font-size: 25px">*</span>
                         <asp:DropDownList CssClass="form-control select2" runat="server" ID="hasBinder" Placeholder="Select Source of Wealth">                           
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:DropDownList CssClass="form-control" runat="server" ID="modeofpayments"></asp:DropDownList>
                    </div>
                </div>
                    <div class="col-md-6 col-lg-6">
                    <div class="form-group">
