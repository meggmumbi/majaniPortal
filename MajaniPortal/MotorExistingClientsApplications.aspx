<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="MotorExistingClientsApplications.aspx.cs" Inherits="MajaniPortal.MotorExistingClientsApplications" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainBody" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Policy Holder No.</label><span class="text-danger" style="font-size: 25px">*</span>
                        <asp:DropDownList CssClass="form-control select2" runat="server" ID="policyHolder" OnSelectedIndexChanged="ValidateCustomerDetails_Onclick" AutoPostBack="true"></asp:DropDownList>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control text-transform:uppercase" runat="server" ID="growerNumber" ReadOnly="true" MaxLength="9"></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control" runat="server" ID="txtIdNumber" TextMode="Number" ReadOnly="true" MaxLength="8"></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label>Address </label>
                        <span class="text-danger" style="font-size: 25px">*</span>
                        <asp:TextBox CssClass="form-control" runat="server" ID="txtaddress" ReadOnly="true" TextMode="Number"></asp:TextBox>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox CssClass="form-control select2" runat="server" ID="lblcity" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <asp:TextBox CssClass="form-control" runat="server" ID="valuesuminsured" TextMode="Number" OnTextChanged="ValidateValueInsured_Click" AutoPostBack="true"></asp:TextBox>
            ...
            <div class="form-group">
                <asp:Button runat="server" CssClass="btn btn-success pull-right" Text="Add Risk Details" OnClick="SubmitRiskDetails_Click" ID="Button1" />
                <div class="clearfix"></div>
            </div>
            <br />
            <br />
                ...
                <table id="example2" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <%
                            ...
                            var applications = nav.QuoteRiskDetails.Where(r => r.Qoute_No == requisitionNo);
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="btn btn-success"><a href="MotorExistingOptionalBenefits.aspx?requisitionNo=<%=requisitionNo%>&&Code=<%=application.Code%>&step=<%=step%>"</a><i class="fa fa-share"></i>Optional Benefit</label>
                            </td>
                            <td>
    ...
    <div class="panel panel-primary">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                <strong>Upload OtherDocuments:</strong><span class="text-danger" style="font-size: 25px">*</span>
